...
__author__ = "Arturo Cervantes <cervantesarturo254@gmail.com>"
__version__ = "1.0.0"
__date__ = "24 Julio 2025"
...
def menu_func_export(self, context):
    self.layout.operator(Export3DS.bl_idname, text="PBSU 3DS (.3ds)")


def menu_func_import(self, context):
    self.layout.operator(Import3DS.bl_idname, text="PBSU 3DS (.3ds)")
